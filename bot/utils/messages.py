MESSAGES = {
    ...
    'ERROR_FROM_TINKOFF': 'Произошла ошибка на стороне Тинькофф',
    'LEAVE_DOOR': 'Предлагаем оставить у двери',
    'ACCEPT_DENY_ORDER': 'От вас трубется подтверждение заявки ({}) по адресу ({})',
}
